...
static const char * libreport_proc_namespaces[] = { "ipc", "mnt", "net", "pid", "uts", "user" };
...
#define process_is_in_container libreport_process_is_in_container
int process_is_in_container(pid_t pid);
#define get_pid_of_init libreport_get_pid_of_init
...
#define FILENAME_NAMESPACES_DIFF "namespaces"
#define FILENAME_INIT_CMDLINE "init_cmdline"
